<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.sql.*,java.util.*,java.time.*,com.notes.model.Note,com.notes.model.NoteImplementation"%>
<!DOCTYPE html>
<html>
<head>
<title>Welcome</title>
...
<body>
	...
	String nbName = (String) session.getAttribute("NotebookName");
	if (mail == null) {
		response.sendRedirect("../index.jsp");
	}
	NoteImplementation noi = new NoteImplementation();
	List<Note> list = noi.getNotes(mail);
	...
	<%
		if (check) {
	%>
	<h5 style="text-align: center">No note or notebook is created</h5>
	<h6 style="text-align: center">
		<a href="notebook.jsp">Create one by clicking here</a>
	</h6>
	<%
		} else {
	for (Note note : list) {
	...
	}if(!result){%><h5 style="text-align: center">No Daily Tasks</h5><%}
	}} catch (Exception e) {
	out.println(e);
	}
	%>
